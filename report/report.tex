...
Also contained, is a handful of input parsing functions.
...
In the default implementation of \texttt{match_attributes}, \texttt{get_attributes} is called. In this case, \texttt{get_attributes} is expected to return a dictionary.
