...
The \texttt{memorymap} module implements the \emph{memorymap} class as described in \ref{sec:memmap}, and works by mapping a virtual `index space' to a pair of  actual indices, referring to to one of the \emph{memoryview} objects it is composed of and it's .

It stores it's constituent views in a list, along with their logical starting and ending index.

A \emph{logical index} 
